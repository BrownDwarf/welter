...
\begin{figure*}
 ...
 \includegraphics[trim=2.6cm 13.0cm 2.8cm 3.2cm, clip=true, width=0.45\textwidth]{figures/bv_pec13} 
   ...
   \includegraphics[trim=2.6cm 13.0cm 2.8cm 2.2cm, clip=true, width=0.45\textwidth]{figures/vr_pec13}
    \end{tabular}
\caption[Polychromatic phase variation]{The observed optical colors of LkCa 4 from \citet{grankin08}, compared with predictions from converting $V$-band brightness to a cool spot filling factor and subsequently calculating colors from main sequence colors and bolometric corrections of \citet{kenyon95} (purple lines).}
\label{fig:colors}
\end{figure*}
