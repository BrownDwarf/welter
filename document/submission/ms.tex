...
Ages and masses of young stars are often estimated by comparing their observed luminosities and effective temperatures to pre-main sequence stellar evolutionary model tracks, but magnetic fields and starspots complicate this process. In order to understand their influence, we study in detail the heavily-spotted weak-lined \emph{T-Tauri} star LkCa 4 by searching for spectral signatures of radiation originating from the starspot or starspot groups.  We introduce a new methodology for constraining both the starspot filling factor and the typical spot temperature by fitting two-temperature stellar atmosphere models constructed from \PHOENIX\ synthetic spectra to a high-resolution near-IR IGRINS spectrum.  Clearly discernable spectral features arise from both a hot photospheric component $\teffa\sim4100$ K and to a cool component $\teffb\sim2700-3000$ K, with a best-fit filling factor of $\sim80$\%  for the cool photosphere at the time of the observation.  These results are supported by comparisons of this mix of hot and cool photospheric temperatures by analyses of the spectral energy distribution, rotational modulation of colors and of TiO band strengths, and low-resolution optical/near-IR spectroscopy.  LkCa 4 has either a warm photosphere mostly covered in cool spots or is a very cool star with a small hot spot.  The revised effective temperature and luminosity make LkCa 4 appear much younger and lower mass when compared to previous estimates with the same unspotted stellar evolution models, although appropriate comparisons require the 
production and adoption of spotted evolutionary models.  Biases from starspots likely afflict most fully convective young stars and contribute to uncertainties in open cluster ages inferred from low-mass stars and in large apparent age spreads of those clusters.  In some spectral regions starspots act as a featureless ``veiling'' continuum owing to the large rotational broadening ($\vsini\sim28$ km~s$^{-1}$) and heavy line-blanketing in cool star spectra.  Some evidence is also found for an anti-correlation between the velocities of the warm and cool components.
\end{abstract}
...
between the main sequence and pre-main sequence temperature scales because the pre-main 
...
%LkCa 4 is not located deeply within a molecular cloud and is not directly associated with any nearby Class 0/1 stars, which would be expected for a 0.5 Myr star.  Dynamical measurements of masses of young stars with similar optical properties suggest that LkCa 4 should have a mass of $\sim 0.7-1.0$ M$_\odot$ \citep[e.g.][]{guilloteau14,czekala16,rizzuto16}.
...
In this paper, we have demonstrated that the IGRINS spectra of LkCa 4 is well fit with two temperatures, a hot photosphere of 4100 K and large cool patches of 2700--3000 K that cover 80\% of the stellar surface.  This solution reproduces the high-resolution $HK$-band spectra obtained with IGRINS, the broadband SED, and rotational modulation of spectral features.  Such a high covering fraction for a spot seems extraordinary, but may be common among young stars.  In this section, we describe that the need for a large cool spot is robust, despite some simplifying limitations of our spectral inference technique.  We also discuss how such a large spot could be interpreted, and suggest that even though LkCa 4 appears extreme, other young sources have similar characteristics.
...
New results from \citet{fang2016} show that large starspot coverage fractions of $50\%$ are common even among stars in the Pleiades, which at $\sim 125$ Myr are much older than the 1--10 Myr old stars in the Taurus Molecular Cloud.  LkCa 4 breaks the apparent ceiling at 50\% coverage fraction of cool starspots, though it is not clear how to classify stars for which the minority of the surface is purportedly the ambient photosphere.  A high fraction of the stellar surface may be covered in spots without inducing any photometric modulation, if the spoits are located in circumpolar regions that always face towards our line-of-sight, in longitudinally symmetric bands, or in many isotropic small spots.  
