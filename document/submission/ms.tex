...
Ages and masses of young stars are often estimated by comparing their observed luminosities and effective temperatures to pre-main sequence stellar evolutionary model tracks, but nonstandard physics like magnetic fields and starspots complicate this process. In order to understand their influence, we study in detail the heavily-spotted weak-lined \emph{T-Tauri} star LkCa 4 by searching for spectral signatures of radiation originating from the starspot or starspot groups.  We introduce a new methodology for constraining both the starspot filling factor and the typical spot temperature by fitting two-temperature stellar atmosphere models constructed from \PHOENIX\ synthetic spectra to a high-resolution near-IR IGRINS spectrum.  Clearly discernable spectral features arise from both a hot photospheric component $\teffa\sim4100$ K and to a cool component $\teffb\sim2700-3000$ K, {\bf with a best-fit filling factor of $\sim80$\%  for the cool photosphere at the time of the observation.} {\bf These results are supported by comparisons of this mix of hot and cool photospheric temperatures by analyses of the spectral energy distribution, rotational modulation of colors and of TiO band strengths, and low-resolution optical/near-IR spectroscopy.  LkCa 4 has either a warm photosphere mostly covered in cool spots or is a very cool star with a small hot spot.}  The revised effective temperature and luminosity make LkCa 4 appear much younger and lower mass when compared to previous estimates and naively using the same model tracks.  Biases from starspots likely afflict most {\bf fully convective} young stars and contribute to uncertainties in open cluster ages inferred from low-mass stars and in large age spreads of those clusters. We also discuss the detailed influence of starspots on the IGRINS spectrum, which in some regions acts as a relatively featureless ``veiling'' continuum owing to the large rotational broadening ($\vsini\sim28$ km~s$^{-1}$) and heavy line-blanketing in cool star spectra, {\bf and anti-correlations expected in the velocity jitter of the warm and cool components.  I put this in cause I think it's interesting, but delete if you do not want to highlight this in the abstract.}
...
{\bf reordered to place main result first}
...
\begin{figure*}
 \centering
 \includegraphics[trim=2.1cm 3.0cm 1cm 7.7cm, clip=true, width=0.70\textwidth]{lores_panels_paper_new}
...
%\caption{Top:  The low-resolution optical/near-IR spectrum of LkCa 4 obtained from Palomar/DBSP and APO/Triplespec on 30 December 2008 (black), compared to a synthetic spectrum of a two temperature photosphere (purple).  The inset shows that the 2750 K (red, 80\% fill factor) and 4100 K (blue, 20\% fill factor) components contribute equally to the near-IR spectrum, but the 4100 K component dominates the blue emission.  The synthetic spectrum is reddened by $A_V=0.3$ mag and scaled to the observed $J$-band spectrum. Bottom:  The low-resolution optical (left) and near-IR (right) spectrum of LkCa 4, compared with a 3900 K photosphere (blue), a 3500 K photosphere (red), and the two temperature photosphere (pink) that best fits the IGRINS spectrum.  The synthetic spectra are scaled separately to the optical spectrum at 0.75 $\mu$m and to the near-IR spectrum at 1.5 $\mu$m.  Warm photospheres accurately reproduce molecular bands at $0.7$ $\mu$m but fail to fit the spectral features at longer wavelengths.  Cooler photospheres predict molecular bands at $<0.7$ $\mu$m that are much deeper than observed.  The two temperature photosphere accurately fits spectral features in both optical and near-IR wavelengths.}
...
\begin{figure*}
 \centering
 \includegraphics[trim=1.6cm 12.6cm 2.2cm 2.4cm, clip=true, width=0.60\textwidth]{vband_spot_master}
...
\begin{figure*}
 \centering
 \includegraphics[trim=3.2cm 3.3cm 2.6cm 8.3cm, clip=true, width=0.65\textwidth]{lkca4_tio_forpaper2}
...
{\bf just a note, I do really like this subsection, it's very simple.}
