...
\author{Michael A. Gully-Santiago,\altaffilmark{1} Gregory J. Herczeg,\altaffilmark{1} Ian Czekala,\altaffilmark{2} Garrett Somers,\altaffilmark{3} Konstantin Grankin,\altaffilmark{4} Kevin Covey,\altaffilmark{5} J.F. Donati,\altaffilmark{6,7} Silvia Alencar,\altaffilmark{8} Gaitee Hussain,\altaffilmark{9} Benjamin J. Shappee,\altaffilmark{10,11} Gregory Mace,\altaffilmark{12} Jae-Joon Lee\altaffilmark{13} T.~W.-S.~Holoien,\altaffilmark{14,15} Jessy Jose,\altaffilmark{1} Chun-Fan Liu\altaffilmark{16}}
...
\altaffiltext{7}{Universit\`e de Toulouse, UPS-OMP, IRAP, 14 avenue E. Belin, Toulouse, F–31400 France}
\altaffiltext{8}{TBD--Alencar}
\altaffiltext{9}{TBD--Hussain ESO and IRAP}
\altaffiltext{10}{Carnegie Observatories, 813 Santa Barbara Street, Pasadena, CA 91101, USA}
\altaffiltext{11}{Hubble and Carnegie-Princeton Fellow}
\altaffiltext{12}{Department of Astronomy, The University of Texas at Austin, 2515 Speedway St, Austin, TX, USA}
\altaffiltext{13}{TBD--Lee}
\altaffiltext{14}{Department of Astronomy, The Ohio State University, 140 West 18th Avenue, Columbus, OH 43210, USA}
\altaffiltext{15}{Center for Cosmology and AstroParticle Physics (CCAPP), The Ohio State University, 191 W. Woodruff Ave., Columbus, OH 43210, USA}
\altaffiltext{16}{Institute of Astronomy and Astrophysics, Academia Sinica (ASIAA), P.O. Box 23-141, Taipei 10641, Taiwan}
...
Ages and masses of young stars can be estimated by comparing their observed luminosities and effective temperatures to pre-main sequence stellar evolutionary model tracks, but nonstandard physics like magnetic fields and starspots complicate this process. In order to understand their influence, we study in detail the heavily-spotted weak-lined \emph{T-Tauri} star LkCa 4 by searching for spectral signatures of radiation originating from the starspot or starspot groups. To do this, we introduce new methodology for constraining both the starspot filling factor and the typical spot temperature, which involves fitting two-temperature stellar atmosphere models constructed from \PHOENIX\ synthetic spectra to a high-resolution near-IR IGRINS spectrum. We detect spectral features attributable to both an ambient photosphere $\teffa\sim4100$ K and cool starspots $\teffb\sim2700-3000$ K, and derive consistently large ($>50\%$) fill factors across all IGRINS spectral orders, with a best fit filling factor of $f\sim80$\% starspots at the epoch of spectrum acquisition. These results are bolstered by the spectral energy distribution, color variability, TiO variability, rotational modulation, and low-resolution optical/IR spectroscopy, which collectively provide broad support for the picture of an extremely heavily spotted star with secularly changing starspot filling factors and temperature contrasts through time. A persistent hotspot covering $\sim20$\% of the surface is a plausible alternative explanation. The revised effective temperature and luminosity make LkCa 4 appear much younger and lower mass when compared to previous measurements, a bias likely afflicting most young, heavily spotted stars, and which may contribute to observed age spreads in open clusters. We also discuss the detailed influence of starspots on the IGRINS spectrum, which in some regions acts as a relatively featureless ``veiling'' continuum owing to the large rotational broadening ($\vsini\sim28$ km~s$^{-1}$) and heavy line-blanketing in cool star spectra.
...
For LkCa 4 in 2015 the $\Delta V\sim 0.5$ mag amplitude corresponds to an absolute minimum fill factor $f>0.37$.  At least 37\% of the stellar disk is covered in starspots at minimum light.  In the 2004 season, LkCa 4 exhibited $\Delta V\sim 0.8$, corresponding to a minimum fill factor of $f=0.52$.

If \emph{any} of these assumptions is relaxed, the minimum fill factor \emph{increases}.  
