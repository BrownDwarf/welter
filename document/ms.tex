...
Starspots have recently been observed with few parts per million photometric precision from monitoring surveys targeting exoplanet transits (Harrison, Davenport, etc.).  Contemporaneous or near-contemporaneous panchromatic photometric monitoring (Grankin, etc.) can break the degeneracy between starspot areal filling factor and starspot temperature. Photometric measurements are limited to detecting the largest longitudinally asymmetric starspots.  Transiting planets or eclipsing binaries passing in front of starspots (cite XX) can break geometric degeneracies, providing estimates for the characteristic sizes and lifetimes of starspots or starspot groups.  Zeeman Doppler Imaging (ZDI, cite XX) suffers from the same longitudinally-asymmetric limitation as photometry, but yields information on the latitudinal distribution of starspots.  All of these techniques would underestimate the starspot areal coverage of pole-on stars, stars with longitudinally symmetric bands of starspots (e.g. bands), or stars with an isotropic distribution of small starspots.  

Spectroscopic strategies have the power to measure both the average areal coverage and the area-weighted average starspot temperature contrast in any geometric configuration.  At low resolution, SED modeling (Wolk and Walker) has detected evidence for sunspots in weak-lined T-Tauri stars (WTTS).  At high resolution, line depth ratio analysis (Neff, etc) has historically been demonstrated in isolated regions of spectrum, namely the TiO bands (cite O'Neal, Neff, etc), OH 1.5 micron feature (O'Neal, etc.), and others.  
