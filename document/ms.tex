...
\includegraphics[trim=2.6cm 13.0cm 2.3cm 2.5cm, clip=true, width=0.48\textwidth]{figures/jbandjump}
...
\begin{figure*}
 \centering
 \includegraphics[trim=2.6cm 13.0cm 2.8cm 3.5cm, clip=true, width=0.65\textwidth]{figures/lkca4_hrdiag_paper2}
