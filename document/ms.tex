...
LkCa 4 has recently been examined with ZDI \citep{donati14}.  Unanswered questions about the large disagreement ($\Delta \teff \sim$500 K) in LkCa 4's effective temperature \citep{herczeg14, donati14} remain.
...
\comm{From discussion with GJH about lifetime of spots:  Where to put the source on the observational HR diagram depends on what your assumptions for its evolutionary history are.}
